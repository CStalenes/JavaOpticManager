...
public class PanelClients extends PanelDeBase implements ActionListener {
	...
	public PanelClients() {
		...
		this.panelForm.add(new JLabel("Prénom Cli : ")); 
		...
		String entetes [] = {"idPersonne", "Nom", "Prénom", "Adresse", "Email", "Age",  "Telephone"};
	...
	public void traitement (int choix) {
		...
		if (choix ==1 ) {
			...
			//trouver comment convertir un int quand on inserer une donné
			//int numLigne = uneTable.getSelectedRow(); 
