...
public class PanelReservations extends PanelDeBase implements ActionListener{
	...
	{
		ArrayList<Lunette> lesLunettes = Modele.selectAllLunettes();
		this.txtIdLunette.removeAllItems();
		
		for(Lunette uneLunette : lesLunettes)
		{
			this.txtIdLunette.addItem(uneLunette.getIdlunette()+ "-" + uneLunette.getLibelle());//dans mon combobox j'ai pris le champs pas le AS 			
		}
